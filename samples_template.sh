...
rails new OmniauthSample -m rails-templates/apply_omniauth.rb    --skip-javascript --skip-spring
...
# rails new CanSample    -m rails-templates/apply_simple_blog.rb   --skip-javascript --skip-spring
# pushd CanSample
